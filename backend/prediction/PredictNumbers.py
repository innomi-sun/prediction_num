...
class PredictNumbers():
    ...
    def __init__(self):
        ...
        self.ckp_file = {
            'loto7': os.path.join(path, 'checkpoint_epoch(50)_loto7_2022_03_07_1604.pth'),
            'loto6': os.path.join(path, 'checkpoint_epoch(50)_loto6_2022_03_07_1604.pth'),
            'miniloto': os.path.join(path, 'checkpoint_epoch(50)_miniloto_2022_03_07_1604.pth'),
            'numbers3': os.path.join(path, 'checkpoint_epoch(50)_numbers3_2022_03_07_1557.pth'),
            'numbers4': os.path.join(path, 'checkpoint_epoch(50)_numbers4_2022_03_07_1559.pth')}
        self.model = {}
