...
export default boot(async ({ app} ) => {
  app.config.globalProperties.$maxMylotoCountLevel1 = 20
  app.config.globalProperties.$lotoAllNum = {
  ...
  app.config.globalProperties.$lotoNumCount = {
    loto7: 7,
    loto6: 6,
    miniloto: 5,
    numbers4: 4,
  ...
  app.config.globalProperties.$lotoNumTypeId = {
    loto7: 0,
    loto6: 1,
    miniloto: 2,
    numbers4: 3,
